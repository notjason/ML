...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        # f 'testing' is True, set epsilon and alpha to 0
    ...
    def createQ(self, state):
        ...
        #   Then, for each action available, set the initial Q-value to 0.0i
	#if self.learning:
...
def run():
    ...
    agent = env.create_agent(LearningAgent,learning=True,alpha=0.01, epsilon=0.50)
